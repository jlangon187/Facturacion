...
namespace FacturacionDAM.Formularios
{
    public partial class FrmFacrec : Form
    {
        ...
        /// <param name="aIdProveedor"></param>
        /// <param name="aYear"></param>
        /// <param name="aIdFactura"></param>
        public FrmFacrec(BindingSource aBs, Tabla aTabla, int aIdEmisor,
            int aIdProveedor, int aYear, int aIdFactura = -1)
        {
            InitializeComponent();
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            if (mCrearNuevaLinea)
            {
                ...
                FrmLineaFacrec frm = new FrmLineaFacrec(_bsLineasFacturas, _tablaLineasFacturas, idFactura);
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                FrmLineaFacrec frm = new FrmLineaFacrec(_bsLineasFacturas, _tablaLineasFacturas, idFactura, true);
                if (frm.ShowDialog(this) == DialogResult.OK)
                {
                    _tablaLineasFacturas.Refrescar();
                    ActualizarEstado();
        ...
        private void InitFactura()
        {
            ...
            // Campos básicos.
            lbNIFCIFProveedor.Text = "";
            lbNIFCIFEmisor.Text = "";
            lbNombreProveedor.Text = "";
            lbNombreEmisor.Text = "";
            txtNumero.Text = "";
        ...
        /// <summary>
        /// Carga los datos del emisor y del Proveedor en la factura
        /// </summary>
        ...
        private bool CargarDatosEmisorYProveedor()
        {
            ...
            {
                lbNIFCIFProveedor.Text = tCli.LaTabla.Rows[0]["nifcif"].ToString();
                lbNombreProveedor.Text = tCli.LaTabla.Rows[0]["nombrecomercial"].ToString();
        ...
        {
            string eSql = $"SELECT * FROM facreclin WHERE id = -1";
        ...
        {
            string eSql = $"SELECT * FROM facreclin WHERE idfacrec = {idFactura}";
            if (_tablaLineasFacturas.InicializarDatos(eSql))
                _bsLineasFacturas.DataSource = _tablaLineasFacturas.LaTabla;
        }
        ...
        private void PrepararBindingLineas()
        {
            ...
            if (dgLineasFactura.Columns["idfacrec"] != null) dgLineasFactura.Columns["idfacrec"].Visible = false;
        ...
        {
            // =========================================================================
            // 1. EMISOR Y Proveedor (gbEmisorProveedor)
            // =========================================================================
            ...
            gbEmisorProveedor.Controls.Clear();
            ...
            // Fila 1
            tlpEmisor.Controls.Add(label2, 0, 1);         // "NIF Proveedor:"
            tlpEmisor.Controls.Add(lbNIFCIFProveedor, 1, 1);
            tlpEmisor.Controls.Add(label3, 2, 1);         // "Nombre Proveedor:"
            tlpEmisor.Controls.Add(lbNombreProveedor, 3, 1);
            ...
            gbEmisorProveedor.Controls.Add(tlpEmisor);


            // =========================================================================
            // 2. DATOS FACTURA (gbFacrec)
            // =========================================================================
            ...
            gbFacrec.Controls.Add(tlpDatos);
