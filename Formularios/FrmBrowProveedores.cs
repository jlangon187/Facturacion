...
namespace FacturacionDAM.Formularios
{
    ...
    {
        private Tabla _tabla;       // Tabla de Proveedores
        ...
        {
            if (_tabla.InicializarDatos("SELECT * FROM proveedores;"))
            {
            ...
            {
                MessageBox.Show("No se han podido cargar los Proveedores.", "Error",
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (_bs.Current is DataRowView row)
            {
                if (MessageBox.Show("¿Estás seguro de que deseas eliminar este proveedor?", "Confirmar eliminación",
                    MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    {
                        Program.appDAM.RegistrarLog("Error al eliminar proveedor", ex.Message);
                        return;
                    }
                }
            }
        ...
        /// <summary>
        /// Personaliza el DataGridView para Proveedores
        /// </summary>
        ...
        private void btnExportXML_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
                ExportarDatos.ExportarXML((DataTable)_bs.DataSource, saveFileDialog.FileName, "Proveedores");
        }
    }
}
